<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyWebSiteDemoMasterPage.aspx.cs" Inherits="MyWebSiteDemoMasterPage" %>
...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            <td colspan="5" style="text-align: center; font-size: xx-large">
               Welcome to Master Page</td>
        </tr>
        <tr>
